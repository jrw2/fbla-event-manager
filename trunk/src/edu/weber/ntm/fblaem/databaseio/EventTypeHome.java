 ...
 * @see edu.weber.ntm.fblaem.databaseio.EventType
...
public class EventTypeHome {
	...
	public EventTypeHome(SessionFactory sessionFactory)
	{
	...
	public EventType findById(java.lang.Integer id) {
		...
		try {
			EventType instance = (EventType) sessionFactory.getCurrentSession()
					.get("edu.weber.ntm.fblaem.databaseio.EventType", id);
			if (instance == null) {
	...
	public List findByExample(EventType instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria("edu.weber.ntm.fblaem.databaseio.EventType")
